...
interface OrphanageRouterParam {
  id: string;
}

export default function Orphanage() {
  const params = useParams<OrphanageRouterParam>();
          ...
          <div className="orphanage-details-content">
            ...
            <div className="map-container">
              ...
              >
                ...
                />
                <Marker interactive={false} icon={logoPointer} position={[orphanage.latitude,orphanage.longitude]} />
              </Map>
